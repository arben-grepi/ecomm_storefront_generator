    ...
    <>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          {mode === 'edit' && onRegenerateContent && (
            <button
              type="button"
              onClick={onRegenerateContent}
              disabled={isGeneratingAIContent}
              className="flex items-center gap-1.5 rounded-full border border-emerald-300 bg-emerald-50 px-3 py-1.5 text-xs font-medium text-emerald-700 transition hover:bg-emerald-100 dark:border-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 dark:hover:bg-emerald-900/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
