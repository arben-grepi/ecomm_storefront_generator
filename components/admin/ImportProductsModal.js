...
export default function ImportProductsModal({ isOpen, onClose, onImport }) {
  ...
  return createPortal(
    ...
    >
      <div
        className="relative w-full h-full sm:h-auto sm:w-full sm:max-w-5xl sm:rounded-3xl border-0 sm:border border-zinc-200/70 bg-white/95 p-4 sm:p-8 shadow-xl backdrop-blur-sm dark:border-zinc-800/80 dark:bg-zinc-900/95 sm:my-8"
