...
/**
 * MinimalPreviewProductCard - Original preview card style
 */
export default function MinimalPreviewProductCard({
  colorPalette,
  nameColor = 'primary',
  nameFont = 'primary',
  nameFontSize = 0.65,
      ...
      <div className={`group flex w-full flex-col overflow-hidden ${borderRadiusClass} bg-white/90 shadow-sm border-0 transition hover:-translate-y-1 hover:shadow-xl`}>
        ...
        <div className="flex flex-1 flex-col gap-3 p-3 sm:p-5">
          <div className="min-h-[2.5rem]">
            <h3 
              className="font-medium uppercase tracking-[0.25em] line-clamp-2"
              style={{
