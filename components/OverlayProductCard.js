  ...
  return (
    <div className="relative">
      <Link
        href={productPath}
        onClick={handleClick}
        className={`group flex w-full flex-col overflow-hidden ${borderRadiusClass} bg-white/90 shadow-lg transition hover:shadow-2xl`}
        prefetch
      >
...
export default memo(OverlayProductCard);
