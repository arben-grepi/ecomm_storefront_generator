...
export default async function Home() {
  // 🔍 ROOT PAGE (LUNERA STOREFRONT) - Set breakpoint here in Cursor
  // Root URL (blerinas.com/) serves LUNERA storefront
  ...
  // Root page is always LUNERA storefront (default storefront)
  const storefront = 'LUNERA';
  const market = await getMarketFromHeaders(headersList);
  console.log(`[SSR] 📍 Using storefront: ${storefront} (root), market: ${market}`);
