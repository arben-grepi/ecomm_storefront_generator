...
export const LOCATION_MARKET_MAPPING = {
  // DSers fulfillment service - global dropship fulfillment for European markets
  // This location handles all orders for Germany, Finland, and other European countries
  "114729156951": {
    name: "dsers-fulfillment-service",
    markets: ["FI", "SE", "NO", "DK", "DE", "FR", "IT", "ES", "NL", "BE", "AT", "CH", "PL", "CZ", "IE", "GB", "US", "CA", "GLOBAL"], // Can ship globally
    priority: 1, // Primary location for all markets
  },
};
