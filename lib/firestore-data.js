...
export const useCategories = (initialCategories = [], storefrontProp = null) => {
  ...
  console.log(`[HOOK] 🎣 useCategories initialized - Initial categories: ${initialCategories.length}, Loading: ${loading}, Storefront: ${storefront} (from ${storefrontProp ? 'prop' : 'context'})`);
  ...
  useEffect(() => {
    ...
    console.log(`[HOOK] 🔥 useCategories: Starting Firestore listener for storefront: ${storefront}`);
...
export const useAllProducts = (initialProducts = [], storefrontProp = null) => {
  ...
  console.log(`[HOOK] 🎣 useAllProducts initialized - Initial products: ${initialProducts.length}, Loading: ${loading}, Market: ${market}, Storefront: ${storefront} (from ${storefrontProp ? 'prop' : 'context'})`);
  ...
  useEffect(() => {
    ...
    console.log(`[HOOK] 🔥 useAllProducts: Starting Firestore listener for storefront: ${storefront}, market: ${market}`);
    const listenerStartTime = Date.now();
