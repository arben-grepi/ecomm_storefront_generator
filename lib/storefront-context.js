...
export function StorefrontProvider({ children }) {
  ...
  const storefront = typeof window !== 'undefined' ? getStorefront() : 'FIVESTARFINDS';
...
export function useStorefront() {
  ...
  // Return context value (will be 'FIVESTARFINDS' default if context not available on server)
  return context?.storefront || 'FIVESTARFINDS';
}
