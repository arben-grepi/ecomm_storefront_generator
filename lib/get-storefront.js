 ...
 * Examples:
 * - /FIVESTARFINDS/... → 'FIVESTARFINDS'
 * - /HEALTH/... → 'HEALTH'
 * - /admin/... → 'FIVESTARFINDS' (default)
 * 
 * @returns {string} Storefront code (default: 'FIVESTARFINDS')
 */
export function getStorefront() {
  ...
  if (pathname === '/cart' || pathname.startsWith('/cart/')) {
    ...
    // Root path (/) redirects to FIVESTARFINDS (handled by middleware)
