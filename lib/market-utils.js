...
/**
 * Active storefronts for admin + routing.
 * Only these appear in product/category storefront selectors.
 * Add a storefront here when launching a new shop (even if old Firestore folders still exist).
 */
export function getActiveStorefronts() {
  return Object.keys(STOREFRONT_MARKETS);
}
