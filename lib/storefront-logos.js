 ...
 */
export function getStorefrontLogo(storefront = 'FIVESTARFINDS', info = null) {
  // Normalize storefront to uppercase to ensure case-insensitive matching
  const normalizedStorefront = storefront ? storefront.toUpperCase() : 'FIVESTARFINDS';
 ...
 */
export function getStorefrontTheme(storefront = 'FIVESTARFINDS', info = null) {
 ...
 */
export function getStorefrontBanner(storefront = 'FIVESTARFINDS') {
  const normalizedStorefront = storefront ? storefront.toUpperCase() : 'FIVESTARFINDS';
  return BANNER_IMAGES[normalizedStorefront] || BANNER_IMAGES.FIVESTARFINDS;
}
